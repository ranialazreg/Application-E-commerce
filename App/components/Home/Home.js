...
const Home = ({ navigation }) => {
  ...
  const retrieveSocks = () => {
    ProduitService.getTwoProduitSocksCategorie()
      .then((response) => {
  ...
  const retrieveProducts = () => {
    ProduitService.getTenTopProduits()
      .then((response) => {
    ...
    >
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          >
            Votre confiance envers notre plateforme de 
            {"\n"}vente est grandement appréciée, merci
          </Text>
        </View>
        <View
          style={{
